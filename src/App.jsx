...
function App() {
  ...
  const cities = [
    ...
    { id: 2, name: "تبریز", temp: 25, desc: "کاملا ابری - بارش باران" },
    { id: 3, name: "مشهد", temp: 25, desc: "کاملا صاف" },
    { id: 4, name: "شیراز", temp: 25, desc: "احتمال بارش" },
    { id: 5, name: "یزد", temp: 25, desc: "بارش برف" },
  ];
